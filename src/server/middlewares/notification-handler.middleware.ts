...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'trainer.create': {
    ...
    key: 'trainer-registration',
    tenantPath: ['platform', 'user', 'trainer'],
    userPath: [],
  },
  'trainer.delete': {
    roles: ['business-owner', 'admin'],
  ...
  'booking.create': {
    roles: ['business-owner', 'billing-manager'],
    key: 'new-booking',
    tenantPath: ['platform', 'user', 'booking'],
    userPath: [],
  },
  'booking.delete': {
    roles: ['business-owner', 'billing-manager'],
  ...
  'admin.delete': {
    ...
    key: 'admin-removed',
    tenantPath: ['platform', 'user', 'admin'],
    userPath: [],
  },
  'billing_manager.delete': {
    roles: ['business-owner'],
    key: 'billing-manager-removed',
    tenantPath: ['platform', 'user', 'billing_manager'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'trainer', 'admin', 'billing-manager'];
