...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Getmyskills`}</title>

        <meta
          name="description"
          content="Welcome to Getmyskills - Your gateway to finding local skill set trainers. Choose your desired skill, book your preferred slot, make payment, and start learning instantly."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1504805572947-34fad45aed93?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxza2lsbCUyMHRyYWluaW5nfGVufDB8fHx8MTY5Mzg0NDI3NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Getmyskills - Your gateway to finding local skill set trainers. Choose your desired skill, book your preferred slot, make payment, and start learning instantly.`}
            </Text>
            <Box
