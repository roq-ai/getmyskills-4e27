      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl
            ...
            alignItems="center"
            mb="4"
            isInvalid={!!formik.errors?.booking_status}
          >
            <FormLabel htmlFor="switch-booking_status">Booking Status</FormLabel>
            <Switch
              id="switch-booking_status"
              name="booking_status"
              onChange={formik.handleChange}
              value={formik.values?.booking_status ? 1 : 0}
            />
            {formik.errors?.booking_status && <FormErrorMessage>{formik.errors?.booking_status}</FormErrorMessage>}
          </FormControl>
